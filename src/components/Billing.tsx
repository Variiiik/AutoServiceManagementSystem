...
export function Billing() {
      ...
      <html>
        ...
        <body>
          ...
          <div class="vehicle-info">
            ...
            <p><strong>${order.vehicle?.year || ''} ${order.vehicle?.make} ${order.vehicle?.model}</strong><br>
            License Plate: ${order.vehicle?.license_plate || 'N/A'}<br>
            VIN: ${order.vehicle?.vin || 'N/A'}</p>
          </div>
  ...
  const handleDownloadInvoice = () => {
    ...
    a.href = url;
    a.download = `invoice-${selectedOrder.id.slice(0, 8)}.html`;
                ...
                <tr key={order.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">#{order.id.slice(0, 8).toUpperCase()}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm"><strong>Invoice #:</strong> INV-{selectedOrder.id.slice(0, 8).toUpperCase()}</p>
